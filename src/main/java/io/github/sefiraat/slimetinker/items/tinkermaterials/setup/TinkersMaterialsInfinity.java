...
public final class TinkersMaterialsInfinity {
 ...
 private static final TinkerMaterial VOID = new TinkerMaterial(Ids.VOID, SlimefunItem.getById("IE_VOID_INGOT").getItem(), "#5c5756")
 ...
 private static final TinkerMaterial MAGSTEEL = new TinkerMaterial(Ids.MAGSTEEL, SlimefunItem.getById("IE_MAGSTEEL").getItem(), "#730000")
 ...
 private static final TinkerMaterial TITANIUM = new TinkerMaterial(Ids.TITANIUM, SlimefunItem.getById("IE_TITANIUM").getItem(), "#adadad")
 ...
 private static final TinkerMaterial IRON_SINGULARITY = new TinkerMaterial(Ids.IRON_SINGULARITY, SlimefunItem.getById("IE_IRON_SINGULARITY").getItem(), "#8c8c8c")
 .setLiquidTexture(SkullTextures.ALLOY_SILVER)
 ...
 private static final TinkerMaterial GOLD_SINGULARITY = new TinkerMaterial(Ids.GOLD_SINGULARITY, SlimefunItem.getById("IE_GOLD_SINGULARITY").getItem(), "#ffe138")
 ...
 private static final TinkerMaterial COPPER_SINGULARITY = new TinkerMaterial(Ids.COPPER_SINGULARITY, SlimefunItem.getById("IE_COPPER_SINGULARITY").getItem(), "#c99732")
 .setLiquidTexture(SkullTextures.ALLOY_BROWN)
 ...
 private static final TinkerMaterial LEAD_SINGULARITY = new TinkerMaterial(Ids.LEAD_SINGULARITY, SlimefunItem.getById("IE_LEAD_SINGULARITY").getItem(), "#9043ba")
 ...
 private static final TinkerMaterial SILVER_SINGULARITY = new TinkerMaterial(Ids.SILVER_SINGULARITY, SlimefunItem.getById("IE_SILVER_SINGULARITY").getItem(), "#d4d4d4")
 .setLiquidTexture(SkullTextures.ALLOY_SILVER)
 ...
 private static final TinkerMaterial ALUMINUM_SINGULARITY = new TinkerMaterial(Ids.ALUMINUM_SINGULARITY, SlimefunItem.getById("IE_ALUMINUM_SINGULARITY").getItem(), "#b0b0b0")
 .setLiquidTexture(SkullTextures.ALLOY_SILVER)
 ...
 private static final TinkerMaterial TIN_SINGULARITY = new TinkerMaterial(Ids.TIN_SINGULARITY, SlimefunItem.getById("IE_TIN_SINGULARITY").getItem(), "#a89b9b")
 .setLiquidTexture(SkullTextures.ALLOY_SILVER)
 ...
 private static final TinkerMaterial ZINC_SINGULARITY = new TinkerMaterial(Ids.ZINC_SINGULARITY, SlimefunItem.getById("IE_ZINC_SINGULARITY").getItem(), "#9ba8a6")
 .setLiquidTexture(SkullTextures.ALLOY_SILVER)
 ...
 private static final TinkerMaterial MAGNESIUM_SINGULARITY = new TinkerMaterial(Ids.MAGNESIUM_SINGULARITY, SlimefunItem.getById("IE_MAGNESIUM_SINGULARITY").getItem(), "#e8cef5")
 ...
 private static final TinkerMaterial DIAMOND_SINGULARITY = new TinkerMaterial(Ids.DIAMOND_SINGULARITY, SlimefunItem.getById("IE_DIAMOND_SINGULARITY").getItem(), "#e8cef5")
 .setLiquidTexture(SkullTextures.ALLOY_BLUE)
 .setFormBlock("IE_DIAMOND_SINGULARITY")
 .build();

 private static final TinkerMaterial MYTHRIL = new TinkerMaterial(Ids.MYTHRIL, SlimefunItem.getById("IE_MYTHRIL").getItem(), "#4ebdc7")
 ...
 private static final TinkerMaterial ADAMANTITE = new TinkerMaterial(Ids.ADAMANTITE, SlimefunItem.getById("IE_ADAMANTITE").getItem(), "#c93ec2")
 .setLiquidTexture(SkullTextures.ALLOY_TAN)
 ...
 private static final TinkerMaterial MAGNONIUM = new TinkerMaterial(Ids.MAGNONIUM, SlimefunItem.getById("IE_MAGNONIUM").getItem(), "#4a0446")
 .setLiquidTexture(SkullTextures.ALLOY_PURPLE)
 ...
 private static final TinkerMaterial FORTUNE_SINGULARITY = new TinkerMaterial(Ids.FORTUNE_SINGULARITY, SlimefunItem.getById("IE_FORTUNE_SINGULARITY").getItem(), "#f0d541")
 .setLiquidTexture(SkullTextures.ALLOY_PURPLE)
 ...
 private static final TinkerMaterial MAGIC_SINGULARITY = new TinkerMaterial(Ids.MAGIC_SINGULARITY, SlimefunItem.getById("IE_MAGIC_SINGULARITY").getItem(), "#c941e8")
 .setLiquidTexture(SkullTextures.ALLOY_BLUE)
 ...
 private static final TinkerMaterial EARTH_SINGULARITY = new TinkerMaterial(Ids.EARTH_SINGULARITY, SlimefunItem.getById("IE_EARTH_SINGULARITY").getItem(), "#44e34f")
 ...
 private static final TinkerMaterial METAL_SINGULARITY = new TinkerMaterial(Ids.METAL_SINGULARITY, SlimefunItem.getById("IE_METAL_SINGULARITY").getItem(), "#5b615b")
 .setLiquidTexture(SkullTextures.ALLOY_SILVER)
 ...
 private static final TinkerMaterial INFINITY_SINGULARITY = new TinkerMaterial(Ids.INFINITY_SINGULARITY, SlimefunItem.getById("IE_INFINITY_SINGULARITY").getItem(), "#e8cef5")
 .setLiquidTexture(SkullTextures.ALLOY_BLUE_PALE)
